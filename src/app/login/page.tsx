        ...
        <main className="flex flex-col row-start-2 items-center sm:items-start border-gray-200 border-2 border-solid px-20 pt-10 pb-5 rounded-xl">
          <div className="flex flex-col gap-8 items-center content">
            ...
            <Buttons
              ...
              className={`w-full py-5 border-2 hover:bg-slate-300 shadow-sm ${isValidate?"bg-blue-500 text-white border-blue-500":'bg-gray-300 border-red-500 text-gray-900'}`}
              disabled={!isValidate}
            >
            ...
            <div className="flex flex-col gap-2 items-center w-full">
              <Buttons
                onClick={() => {}}
                className={`
                  ${onFocus?'bg-blue-500 text-white hover:bg-blue-600':'bg-gray-300 text-gray-900'}border-black border-2 shadow-sm
                  `}
              >
